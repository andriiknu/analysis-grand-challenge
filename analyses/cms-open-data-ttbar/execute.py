...
for i_run in range(4):
    ...
    for app in ['rdf']:
        ...
        for option in options:
            for nfiles in [650]:# + list(range(250, 3751, 700)):
#                 print(nfiles)
    #             for nfiles in [3750]:
                folder = f'benchmarks/{nfiles}/{option}'
                os.makedirs(folder, exist_ok=True)  
    #            for ncores in [16,32+16,64+16,96+16]:
                for ncores in [96,128]:#[1]+list(range(32,129,32))+list(range(8, 32, 8)):
...
#                 os.makedirs(folder, exist_ok=True)  
#     #            for ncores in [16,32+16,64+16,96+16]:
#                 for ncores in [64]:#[1]+list(range(32,129,32))+list(range(8, 32, 8)):
